...
FLIGHT SHEDULE  (РАСПИСАНИЕ ПОЛЕТОВ)
...
Продумайте структуру модуля, создайте необходимые классы и интерфейсы. Пользовательский интерфейс не рассматривайте. Достаточно вывода информации в консоль. Никаких сторонних библиотек использовать не нужно.
...
1. Создаем класс ScheduleFlight (используется как точка входа первичных данных)
2. Создаем класс FilterFlight (здесь будет вся логика для фильтрации рейсов)
3. В Main вызываем методы из класса FilterFlight
